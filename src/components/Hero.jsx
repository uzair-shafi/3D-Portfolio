...
const Hero = () => {
  return (
    <section className={`relative w-full justify-center h-screen mx-auto -mt-4`}>
      <div
        className={`absolute inset-0 top-[120px]  max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5 -mt-2`}
      >
